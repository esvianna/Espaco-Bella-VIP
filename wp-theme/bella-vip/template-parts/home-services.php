...
$services = array(
	array(
		...
		'image' => get_theme_mod( 'bellavip_service1_image', get_template_directory_uri() . '/assets/images/placeholder.svg' ),
		'link'  => '#gloss-express',
	...
	array(
		...
		'image' => get_theme_mod( 'bellavip_service2_image', get_template_directory_uri() . '/assets/images/placeholder.svg' ),
		'link'  => '#sobre',
	...
	array(
		...
		'image' => get_theme_mod( 'bellavip_service3_image', get_template_directory_uri() . '/assets/images/placeholder.svg' ),
		'link'  => '#localizacao',
