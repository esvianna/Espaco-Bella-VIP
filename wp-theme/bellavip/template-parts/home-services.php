...
$services = array(
	array(
		...
		'desc'  => get_theme_mod( 'bellavip_service1_desc', 'Ideal para suavizar e disfarçar fios brancos, dar brilho intenso e renovar o visual sem aspecto de coloração pesada.' ),
		'image' => get_theme_mod( 'bellavip_service1_image', 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' ),
		'link'  => '#gloss-express',
	...
	array(
		...
		'image' => get_theme_mod( 'bellavip_service2_image', 'https://images.unsplash.com/photo-1562322140-8baeececf3df?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' ),
		'link'  => '#sobre',
	...
	array(
		...
		'image' => get_theme_mod( 'bellavip_service3_image', 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' ),
		'link'  => '#localizacao',
					...
					<div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group border border-transparent hover:border-bella-rose/30">
						...
						<div class="p-8">
							...
							<a href="<?php echo esc_url( $whatsapp_url ); ?>" target="_blank" rel="noopener noreferrer" class="text-bella-terracotta font-medium flex items-center hover:text-[#c27a5d] transition-colors">
								<?php esc_html_e( 'Agendar horário', 'bellavip' ); ?> <span class="ml-2">→</span>
							</a>
						</div>
					</div>
				<?php endif; ?>
